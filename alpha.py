...
def load_event_log(csv_path, case_id='STUDIENR', activity='KURSTXT', timestamp='SEMESTER_START', sep=None, sample_cases: Optional[int]=None, top_activities: Optional[int]=None):
...
def mine_alpha(csv_path,
	...
	log = load_event_log(csv_path, case_id, activity, timestamp, sep=sep, sample_cases=sample_cases, top_activities=top_activities)
...
if __name__ == '__main__':
	...
	mine_alpha(args.input, args.out, args.case, args.activity, args.timestamp, sep=args.sep, sample_cases=args.sample, top_activities=args.top_activities)
